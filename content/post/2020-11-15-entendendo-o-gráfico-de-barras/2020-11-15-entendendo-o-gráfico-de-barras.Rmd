...
Há um pouco menos de um mês atrás escrevi um post falando sobre alguns gráficos comuns na análise de dados. Nele, comentei que pretendia realizar um post específico para cada um. Sendo assim, vamos começar com o famoso gráfico de barras (ou colunas) também conhecido como *barplot*.

<!--more-->

Há um pouco menos de um mês atrás escrevi um post falando sobre alguns gráficos comuns na análise de dados. Nele, comentei que pretendia realizar um post específico para cada um. Sendo assim, vamos começar com o famoso gráfico de barras (ou colunas) também conhecido como *barplot*. Caso você não tenha visto o post sobre eles, clique [aqui](https://nmhahn.netlify.app/2020/10/22/gr%C3%A1ficos-comuns-na-an%C3%A1lise-de-dados/).
